...
// GetGovFromSignor is a free data retrieval call binding the contract method 0x776f711e.
//
// Solidity: function getGovFromSignor(address signor) view returns(address governanceAddress)
func (_Atlas *AtlasCaller) GetGovFromSignor(opts *bind.CallOpts, signor common.Address) (common.Address, error) {
	var out []interface{}
	err := _Atlas.contract.Call(opts, &out, "getGovFromSignor", signor)
...
//
// Solidity: function getGovFromSignor(address signor) view returns(address governanceAddress)
func (_Atlas *AtlasSession) GetGovFromSignor(signor common.Address) (common.Address, error) {
	return _Atlas.Contract.GetGovFromSignor(&_Atlas.CallOpts, signor)
}

// GetGovFromSignor is a free data retrieval call binding the contract method 0x776f711e.
//
// Solidity: function getGovFromSignor(address signor) view returns(address governanceAddress)
func (_Atlas *AtlasCallerSession) GetGovFromSignor(signor common.Address) (common.Address, error) {
	return _Atlas.Contract.GetGovFromSignor(&_Atlas.CallOpts, signor)
}

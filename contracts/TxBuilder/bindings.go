...
// BuildUserOperation is a free data retrieval call binding the contract method 0x1c19f538.
//
// Solidity: function buildUserOperation(address from, address to, uint256 maxFeePerGas, uint256 value, bytes data) view returns((address,(address,address,uint256,uint256,uint256,uint256,uint256,address,bytes),bytes) userOp)
func (_TxBuilder *TxBuilderCaller) BuildUserOperation(opts *bind.CallOpts, from common.Address, to common.Address, maxFeePerGas *big.Int, value *big.Int, data []byte) (UserOperation, error) {
	var out []interface{}
	err := _TxBuilder.contract.Call(opts, &out, "buildUserOperation", from, to, maxFeePerGas, value, data)
...
//
// Solidity: function buildUserOperation(address from, address to, uint256 maxFeePerGas, uint256 value, bytes data) view returns((address,(address,address,uint256,uint256,uint256,uint256,uint256,address,bytes),bytes) userOp)
func (_TxBuilder *TxBuilderSession) BuildUserOperation(from common.Address, to common.Address, maxFeePerGas *big.Int, value *big.Int, data []byte) (UserOperation, error) {
	return _TxBuilder.Contract.BuildUserOperation(&_TxBuilder.CallOpts, from, to, maxFeePerGas, value, data)
}

// BuildUserOperation is a free data retrieval call binding the contract method 0x1c19f538.
//
// Solidity: function buildUserOperation(address from, address to, uint256 maxFeePerGas, uint256 value, bytes data) view returns((address,(address,address,uint256,uint256,uint256,uint256,uint256,address,bytes),bytes) userOp)
func (_TxBuilder *TxBuilderCallerSession) BuildUserOperation(from common.Address, to common.Address, maxFeePerGas *big.Int, value *big.Int, data []byte) (UserOperation, error) {
	return _TxBuilder.Contract.BuildUserOperation(&_TxBuilder.CallOpts, from, to, maxFeePerGas, value, data)
}

// BuildVerification is a free data retrieval call binding the contract method 0x1f55a52b.
//
// Solidity: function buildVerification(address governanceEOA, (address,uint32) dConfig, (address,(address,address,uint256,uint256,uint256,uint256,uint256,address,bytes),bytes) userOp, (address,(address,address,uint256,uint256,uint256,uint256,bytes32,bytes32,bytes32,bytes),bytes,(address,uint256)[])[] solverOps) view returns((address,(address,address,uint256,uint256,bytes32,bytes32,bytes32),bytes) verification)
func (_TxBuilder *TxBuilderCaller) BuildVerification(opts *bind.CallOpts, governanceEOA common.Address, dConfig DAppConfig, userOp UserOperation, solverOps []SolverOperation) (Verification, error) {
	var out []interface{}
	err := _TxBuilder.contract.Call(opts, &out, "buildVerification", governanceEOA, dConfig, userOp, solverOps)

	if err != nil {
		return *new(Verification), err
	}

	out0 := *abi.ConvertType(out[0], new(Verification)).(*Verification)
...
//
// Solidity: function buildVerification(address governanceEOA, (address,uint32) dConfig, (address,(address,address,uint256,uint256,uint256,uint256,uint256,address,bytes),bytes) userOp, (address,(address,address,uint256,uint256,uint256,uint256,bytes32,bytes32,bytes32,bytes),bytes,(address,uint256)[])[] solverOps) view returns((address,(address,address,uint256,uint256,bytes32,bytes32,bytes32),bytes) verification)
func (_TxBuilder *TxBuilderSession) BuildVerification(governanceEOA common.Address, dConfig DAppConfig, userOp UserOperation, solverOps []SolverOperation) (Verification, error) {
	return _TxBuilder.Contract.BuildVerification(&_TxBuilder.CallOpts, governanceEOA, dConfig, userOp, solverOps)
}

// BuildVerification is a free data retrieval call binding the contract method 0x1f55a52b.
//
// Solidity: function buildVerification(address governanceEOA, (address,uint32) dConfig, (address,(address,address,uint256,uint256,uint256,uint256,uint256,address,bytes),bytes) userOp, (address,(address,address,uint256,uint256,uint256,uint256,bytes32,bytes32,bytes32,bytes),bytes,(address,uint256)[])[] solverOps) view returns((address,(address,address,uint256,uint256,bytes32,bytes32,bytes32),bytes) verification)
func (_TxBuilder *TxBuilderCallerSession) BuildVerification(governanceEOA common.Address, dConfig DAppConfig, userOp UserOperation, solverOps []SolverOperation) (Verification, error) {
	return _TxBuilder.Contract.BuildVerification(&_TxBuilder.CallOpts, governanceEOA, dConfig, userOp, solverOps)
}
...
func (_TxBuilder *TxBuilderCaller) Deadline(opts *bind.CallOpts) (*big.Int, error) {
	var out []interface{}
	err := _TxBuilder.contract.Call(opts, &out, "deadline")
...
//
// Solidity: function deadline() view returns(uint256)
func (_TxBuilder *TxBuilderSession) Deadline() (*big.Int, error) {
	return _TxBuilder.Contract.Deadline(&_TxBuilder.CallOpts)
}

// Deadline is a free data retrieval call binding the contract method 0x29dcb0cf.
//
// Solidity: function deadline() view returns(uint256)
func (_TxBuilder *TxBuilderCallerSession) Deadline() (*big.Int, error) {
	return _TxBuilder.Contract.Deadline(&_TxBuilder.CallOpts)
}
...
// GetPayeeData is a paid mutator transaction binding the contract method 0x7dbba9f4.
//
// Solidity: function getPayeeData(bytes data) returns((address,(address,uint256)[],bytes)[])
func (_TxBuilder *TxBuilderTransactor) GetPayeeData(opts *bind.TransactOpts, data []byte) (*types.Transaction, error) {
	return _TxBuilder.contract.Transact(opts, "getPayeeData", data)
}

// GetPayeeData is a paid mutator transaction binding the contract method 0x7dbba9f4.
//
// Solidity: function getPayeeData(bytes data) returns((address,(address,uint256)[],bytes)[])
func (_TxBuilder *TxBuilderSession) GetPayeeData(data []byte) (*types.Transaction, error) {
	return _TxBuilder.Contract.GetPayeeData(&_TxBuilder.TransactOpts, data)
}

// GetPayeeData is a paid mutator transaction binding the contract method 0x7dbba9f4.
//
// Solidity: function getPayeeData(bytes data) returns((address,(address,uint256)[],bytes)[])
func (_TxBuilder *TxBuilderTransactorSession) GetPayeeData(data []byte) (*types.Transaction, error) {
	return _TxBuilder.Contract.GetPayeeData(&_TxBuilder.TransactOpts, data)
}
